 ...
 *
 * @param {string} file
 * @see GitemplateDox.prototype.parseComment
 */
...
GitemplateDox.prototype.convertOne = function(comment) {
  ...
  this.convertHeading(comment);
  this.convertSummary(comment);
  this.convertJsBlocks(comment);
...
GitemplateDox.prototype.prependTOC = function() {
  var source = path.relative(this.get('output'), this.get('input'));
  ...
  lines.push('');
  lines.push(sprintf('Source: [%s](%s)', source, source));
  lines.push('');
 ...
 * @api private
 */
GitemplateDox.prototype.convertHeading = function(comment) {
  var method = this.method(comment);
 ...
 * @api private
 */
GitemplateDox.prototype.convertJsBlocks = function(comment) {
...
GitemplateDox.prototype.newline = function(line) {
  this.lines.push('');
};
 ...
 *
 * @param {object} comment dox-provided comment metadata
