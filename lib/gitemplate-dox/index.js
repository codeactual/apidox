...
GitemplateDox.prototype.convertOne = function(md, comment) {
  this.commentHeading(md, comment);
  this.commentSummary(md, comment);
  this.commentJsBlocks(md, comment);
};

GitemplateDox.prototype.commentHeading = function(md, comment) {
  md.h(1, comment.ctx.string);
};

GitemplateDox.prototype.commentSummary = function(md, comment) {
  md.p(comment.description.summary);
};

GitemplateDox.prototype.commentJsBlocks = function(md, comment) {
